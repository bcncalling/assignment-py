...
async def get_users():
    try:
        ...
        return JSONResponse(
            status_code=500,
            content={"message": "Could not fetch users"},
        )
...
async def get_user(id: str):
    try:
        ...
        return JSONResponse(
            status_code=500,
            content={"message": "Could not fetch user"},
        )
...
async def update_user(id: str, user: User):
    try:
        ...
        return JSONResponse(
            status_code=500,
            content={"message": "Could not update user"},
        )
...
async def delete_user(id: str):
    try:
        ...
        return JSONResponse(
            status_code=500,
            content={"message": "Could not delete user"},
        )
...
async def upload_profile_pic(id: str, file: UploadFile = File(...)):
    try:
        ...
        return JSONResponse(
            status_code=200,
            content={"message": "Profile pic uploaded successfully"},
        )
    except Exception as e:
        print(e)
        return JSONResponse(
            status_code=500,
            content={"message": "Could not upload profile pic"},
        )
...
async def get_profile_pic(id: str):
    try:
        ...
        return StreamingResponse(
            BytesIO(user["profile_pic"]["data"]),
            media_type="image/png",
            headers={
                "Content-Disposition": f'attachment; filename="{user["profile_pic"]["filename"]}"'
            },
        )
    except Exception as e:
        print(e)
        return JSONResponse(
            status_code=500,
            content={"message": "Could not fetch profile pic"},
        )
